...
exports.handler = async (event, context) => {
    ...
    const { mes, año } = JSON.parse(event.body);
    ...
    try {
        ...
        // Ejecutar la consulta con las fechas proporcionadas
        const [rows] = await connection.execute(selectQuery, [fechaInicial, fechaFinal]);
